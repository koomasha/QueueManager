navRoutes = [
  new NavRoute('home', '', {isMainNav: false, template: 'home', layoutTemplate: 'homeLayout'})
  new NavRoute('mobile', '', {isMainNav: false, template: 'mobile', layoutTemplate: 'moLayout'})
  ...
  new NavRoute('welcome', '', {isMainNav: false, template: 'welcome', layoutTemplate: 'loginLayout'})
]
